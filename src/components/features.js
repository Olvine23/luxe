...
export const Feature = () => {
  return (
    <div name="deals" className="  px-4 py-0 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        ...
        <div className="grid gap-10 lg:grid-cols-2">
          ...
          <div className="lg:pr-10">
            ...
            <p className="mb-6 text-gray-900">
              Luxe Unlimited in committed to offer competent property management
              to yield competitive results and help achieve our clients’
              visions.
            </p>
      ...
      {/* <div className="grid max-w-screen-lg gap-8 row-gap-10 mx-auto lg:grid-cols-2">
        <div className="flex flex-col max-w-md sm:mx-auto sm:flex-row">
          <div className="mr-4">
            <div className="flex items-center justify-center w-12 h-12 mb-4 rounded-full bg-indigo-50"></div>
          </div>
          <div>
